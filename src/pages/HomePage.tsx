  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden" style={{ height: '100dvh', width: '100%' }}>
        <img src={heroImage} alt="Prosecco" className="absolute inset-0 w-full h-full object-cover scale-110 -translate-y-[25px]" />
        <div className="absolute inset-0" style={{ background: 'rgba(43, 78, 55, 0.10)' }} />
        ...
        <div className="absolute bottom-0 left-0 right-0 z-[2] flex flex-col items-center" style={{ padding: '0 24px 100px' }}>
          {/* Centered Logo */}
          <img src={bolicinaLogo} alt="Bolicina" className="w-[280px] mb-6" style={{ filter: 'drop-shadow(0 4px 24px rgba(0,0,0,0.35))', marginTop: -40 }} />
          {/* Tagline */}
