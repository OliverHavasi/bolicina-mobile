  ...
  return (
    <div className="bg-parchment min-h-screen" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
      ...
      <div className="px-4">
        {query.length === 0 ? (
          <>
            <span className="text-micro text-[11px] text-ink-3 block mt-3 mb-2">V Trende Dnes</span>
          ...
          <>
            ...
            {filteredProducers.length > 0 && (
              <>
                <span className="text-micro text-[11px] text-ink-3 block mt-3 mb-2">Producenti</span>
            ...
            {filteredProseccos.length === 0 && filteredProducers.length === 0 && (
              <div className="text-center py-16">
                <p className="font-heading font-semibold text-[18px] text-selce">Žiadne výsledky</p>
                <p className="font-body text-[14px] text-ink-3 mt-1">Skúste iný výraz</p>
              </div>
            )}
          </>
        )}
