...
const regions = [
  { name: 'Valdobbiadene Superiore', slug: 'valdobbiadene', appellation: 'DOCG', count: '1 240', image: regionValdobbiadene, desc: 'UNESCO svetové dedičstvo. Strmé terasy.' },
  { name: 'Conegliano Valdobbiadene', slug: 'conegliano', appellation: 'DOCG', count: '980', image: regionConogliano, desc: 'Historické srdce Prosecca.' },
  { name: 'Cartizze', slug: 'cartizze', appellation: 'DOCG', count: '186', image: regionCartizze, desc: 'Len 107 hektárov. Najprestížnejšia zóna.' },
  { name: 'Asolo Prosecco', slug: 'asolo', appellation: 'DOCG', count: '420', image: regionAsolo, desc: 'Stredoveké mestečká a vinice.' },
  { name: 'Prosecco DOC Rosé', slug: 'rose', appellation: 'DOC', count: '610', image: regionRose, desc: 'Nová kategória od 2020.' },
  { name: 'Prosecco DOC Treviso', slug: 'treviso', appellation: 'DOC', count: '2 100', image: regionTreviso, desc: 'Najväčšia produkčná oblasť.' },
];

const RegionsPage = () => {
  return (
    <div style={{ paddingTop: 'calc(52px + env(safe-area-inset-top, 0px))' }}>
      <TopAppBar title="Regióny" />
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 z-10">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-body text-[11px] text-white/70">{region.count} prosecco</span>
              </div>
